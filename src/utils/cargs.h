...
/**
 * A context is used to iterate over all options provided. It stores the
 * parsing state.
 */
 ...
 *
 * This function prepares the context for iteration and initializes the
 * context with the supplied options and arguments. After the context has
 * been prepared, it can be used to fetch arguments from it.
 *
 * @param context The context which will be initialized.
 * @param options The registered options which are available for the
 * program.
 * @param option_count The amount of options which are available for the
 * program.
 * @param argc The amount of arguments the user supplied in the main
 * function.
 ...
 * The arguments will be re-ordered, which means that non-option arguments
 * will be moved to the end of the argument list. After all options have
 * been fetched, all non-option arguments will be positioned after the index
 * of the context.
 *
 ...
 *
 * This function gets the identifier of the option, which should be unique
 * to this option and can be used to determine what kind of option this is.
 *
 ...
 *
 * This function gets the value from the option, if any. If the option does
 * not contain a value, this function will return NULL.
 *
 * @param context The context from which the option was fetched.
 ...
 *
 * This function gets the index within the argv arguments of the context.
 * The context always points to the next item which it will inspect. This is
